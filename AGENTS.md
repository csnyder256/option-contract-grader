...
GET http://localhost:8900/must-read?project=option-contract-grader

Then search shared memory for the task, using project=option-contract-grader first and global
